...
try
{
	...
	::fast_io::obuf_file soundentrieslua("SoundEntries.lua");
...
{)abc");
	for(auto const & e : soundentriesdb.records)
	{
		...
		if(count)
		{
			...
			if(e.m_ID==36308)	//Orgrimmar Additional because we only have old versions of db2 file. These are guesses. Vulpera
			{
				print(soundentrieslua,"2145688,2145690");
			}// Orgrimmar Night
			else if(e.m_ID==36309)
			{
				print(soundentrieslua,"2145689,2145694");
			}
/*
			else if(e.m_ID==2532)	//Stormwind. AnduinPt1. No Pt2
			{
